...
const returns = [
  { id: 'PR-2024-001', date: '08/03/2024', invoice: 'PI-2024-001', vendor: 'Agri Seeds Ltd', amount: 15000, status: 'Processed' },
  { id: 'PR-2024-002', date: '15/03/2024', invoice: 'PI-2024-002', vendor: 'FarmTech Solutions', amount: 22000, status: 'Pending' },
];
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col h-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Purchase Returns</h1>
          <p className="text-sm text-gray-500 mt-1">Manage returns to vendors and debit notes.</p>
        </div>
        <button 
            ...
            <tbody className="divide-y divide-gray-200">
              {returns.map((ret) => (
                <tr key={ret.id} className="hover:bg-gray-50 transition-colors group">
                  ...
                  <td className="p-4 text-sm text-gray-900 font-medium">{ret.vendor}</td>
                  ...
                  <td className="p-4 flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="text-gray-400 hover:text-green-600 transition-colors" title="Process Debit Note">
