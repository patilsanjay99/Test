...
const orders = [
  { id: 'SO-2024-001', date: '02/03/2024', customer: 'Ramesh Patel', amount: 45000, status: 'Confirmed' },
  { id: 'SO-2024-002', date: '05/03/2024', customer: 'Kisan Traders', amount: 125000, status: 'Pending' },
  { id: 'SO-2024-003', date: '12/03/2024', customer: 'Green Farms', amount: 62000, status: 'Delivered' },
];
            ...
            <tbody className="divide-y divide-gray-200">
              {orders.map((ord) => (
                <tr key={ord.id} className="hover:bg-gray-50 transition-colors group">
                  ...
                  <td className="p-4 text-sm text-gray-900 font-medium">{ord.customer}</td>
