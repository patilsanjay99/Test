    ...
    <div className="max-w-5xl mx-auto flex flex-col space-y-6 pb-12">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Prepare a new estimate for a prospective sale.</p>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-200 bg-gray-50/50 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-1.5">
            ...
            <select className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
              ...
              <option value="2">Agro Retailers (CUST-009)</option>
            </select>
          </div>
          <div className="space-y-1.5">
        ...
        <div className="p-6 border-t border-gray-200">
          <label className="text-sm font-medium text-gray-700 block mb-2">Terms & Conditions</label>
          <textarea 
            ...
            defaultValue="1. Quotes are conditionally valid for 15 days.\n2. Prices are subject to change based on raw material availability."
          ></textarea>
        </div>
      </div>
    </div>
