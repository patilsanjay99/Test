-- Migration script for SQL Server: Add new columns to Companies table

ALTER TABLE Companies ADD PhoneNo NVARCHAR(50) NULL;
ALTER TABLE Companies ADD Address NVARCHAR(MAX) NULL;
ALTER TABLE Companies ADD EmailID NVARCHAR(100) NULL;
...
ALTER TABLE Companies ADD BankName NVARCHAR(100) NULL;
ALTER TABLE Companies ADD BankBranch NVARCHAR(100) NULL;
